...
public class Lvl1{
    ...
    public Lvl1(){
        ...
        walls[8] = new Rechteck(20, 0.2);//
        walls[8].setzeMittelpunkt(-3,-9.25);
        walls[9] = new Rechteck(0.2, 3);//
        walls[9].setzeMittelpunkt(-12.9,-10.75);
        walls[10] = new Rechteck(0.2, 3);//
